...
namespace MovementSystem
{
    ...
    public class CapsuleColliderUtility
    {
        ...
        public void CalculateCapsuleColliderDimensions()
        {
            ...
            float halfCollierHeight = CapsuleColliderData.Collider.height / 2f; 
            if (halfCollierHeight / 2f < CapsuleColliderData.Collider.radius)
            {
                SetCapsuleColliderHeight(halfCollierHeight/ 2f);
            }
